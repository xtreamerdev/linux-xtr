...
#undef ATA_ENABLE_PATA      /* define to enable PATA support in some
                             * low-level drivers */
#define ATA_ENABLE_ATAPI    /* define to enable ATAPI support */    //# abevau add
...
enum {
    ...
    ATA_TMOUT_PIO           = 20*HZ,    //alex for Rootapp 30 * HZ,
    ATA_TMOUT_BOOT          = 20*HZ,    //alex for Rootapp 30 * HZ,  /* hueristic */
    ...
    ATA_TMOUT_11			= 11*HZ, //alex
    ATA_TMOUT_9				= 9*HZ, //alex
    ATA_TMOUT_7				= 7*HZ, //alex
    ATA_TMOUT_5				= 5*HZ, //alex
    ATA_TMOUT_3				= 3*HZ, //alex
    ATA_TMOUT_1				= 1*HZ, //alex
...
struct ata_host_set {
    ...
    unsigned int                ahost_hp_event;
    struct semaphore            sata_sem;
...
struct ata_port {
    ...
    struct work_struct      dma_eh_task;
    struct timer_list       nodata_timer ;

    unsigned int            pio_task_state;
    unsigned long           pio_task_timeout;
    unsigned int            aport_hp_event;
    void                    *private_data;
};
