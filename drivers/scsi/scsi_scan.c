...
#if 0 // remove for unknown partition table bug : race condition
...
int scsi_force_check_device_change(struct device *dev)
{
...
EXPORT_SYMBOL(scsi_force_check_device_change);
