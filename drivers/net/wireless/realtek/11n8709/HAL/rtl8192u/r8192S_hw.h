...
#define 		LBUS_MON_ADDR 		0x0364	// Lexra bus monitor address Register
#define 		LBUS_ADDR_MASK 		0x0368	// Lexra bus monitor address mask Register
...
#define	EEPROM_Optional				0x7A // SU Optional define
...
#define	EEPROM_BLUETOOTH_COEXIST	0x7a // 92su, 0x7a[0]
...
#define		FW_RA_INIT						0xfd000026 // For FW v.52 and later.
#define		FW_RA_IOT_BG_COMB			0xfd000030 // For FW v.52 and later.
#define		FW_RA_IOT_N_COMB				0xfd000031 // For FW v.52 and later.
#define		FW_RA_REFRESH					0xfd0000a0
#define		FW_RA_DISABLE					0xfd0000a4 // Disable RA function.
#define		FW_RA_ACTIVE					0xfd0000a6
#define		FW_RA_DISABLE_RSSI_MASK		0xfd0000ac // Disable RSSI Mask.
#define		FW_RA_ENABLE_RSSI_MASK		0xfd0000ad // Enable RSSI Mask.
...
#define		FW_TX_FEEDBACK_NONE				0xfb000000					// Tx report from FW disabled.
#define		FW_TX_FEEDBACK_DTM_ENABLE		(FW_TX_FEEDBACK_NONE | 0x1)	// Tx report for DTM from FW enabled.
#define		FW_TX_FEEDBACK_CCX_ENABLE		(FW_TX_FEEDBACK_NONE | 0x2) // Tx report for CCX from FW enabled.
