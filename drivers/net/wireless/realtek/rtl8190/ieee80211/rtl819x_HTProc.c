...
static u16 MCS_DATA_RATE[2][2][77] = 
...
void HTIOTPeerDetermine(struct ieee80211_device* ieee)
{
	...
	else if(memcmp(net->bssid, DLINK_ATHEROS, 3)==0)
...
//	u8*	pMcsFilter;
	...
	//
	IEEE80211_DEBUG(IEEE80211_DL_HT, "==============>%s()\n", __FUNCTION__);
	/*unmakr bEnableHT flag here is the same reason why unmarked in function ieee80211_softmac_new_net. WB 2008.09.10*/
