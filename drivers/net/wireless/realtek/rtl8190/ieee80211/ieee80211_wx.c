...
static inline char *
iwe_stream_add_event_rtl(char *     stream,         /* Stream of events */
...
#else
#define iwe_stream_add_event_rtl iwe_stream_add_event
#endif
					   ...
					   struct ieee80211_network *network)
{
	...
	start = iwe_stream_add_event_rtl(start, stop, &iwe, IW_EV_ADDR_LEN);
	...
	*pname = '\0';
	...
	start = iwe_stream_add_event_rtl(start, stop, &iwe, IW_EV_CHAR_LEN);
		...
		start = iwe_stream_add_event_rtl(start, stop, &iwe, IW_EV_UINT_LEN);
	}
...
/*	iwe.u.freq.m = ieee80211_frequency(network->channel, network->mode);
	...
	iwe.u.freq.e = 0;
	iwe.u.freq.i = 0;
	start = iwe_stream_add_event_rtl(start, stop, &iwe, IW_EV_FREQ_LEN);
	...
	start = iwe_stream_add_event_rtl(start, stop, &iwe,
				     IW_EV_PARAM_LEN);
	...
	start = iwe_stream_add_event_rtl(start, stop, &iwe, IW_EV_QUAL_LEN);
