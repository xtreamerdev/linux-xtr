...
#define RTL8190_SUFFIX(item)            r8190_##item
...
//#define COMP_MP					BIT14	// For mass production test, by shien chang, 2006.07.13
#define COMP_RXDESC			BIT13	// Show Rx desc information for SD3 debug. Added by Annie, 2006-07-15.
#define COMP_PHY				BIT15	
#define COMP_DIG				BIT16	// For DIG, 2006.09.25, by rcnjko.
...
#define COMP_POWER_TRACKING	BIT20	//FOR 8190 TX POWER TRACKING
#define COMP_EVENTS			BIT21	// Event handling
...
#define COMP_FIRMWARE			BIT23	//for firmware downloading
#define COMP_HT					BIT24	// For 802.11n HT related information. by Emily 2006-8-11
//#define COMP_RX_REORDER		BIT36	// 8190 Rx Reorder
//#define COMP_AMSDU				BIT25	// For A-MSDU Debugging

//#define COMP_RATR				BIT26	
#define COMP_RESET				BIT25
#define COMP_CMDPKT			BIT26
#define COMP_SCAN				BIT27
#define COMP_DOWN				BIT30  //for rm driver module
...
#define read_cam                RTL8190_SUFFIX(read_cam)
#define write_cam               RTL8190_SUFFIX(write_cam)
#define read_nic_byte           RTL8190_SUFFIX(read_nic_byte)
#define read_nic_byte_E         RTL8190_SUFFIX(read_nic_byte_E)
#define read_nic_dword          RTL8190_SUFFIX(read_nic_dword)
#define read_nic_word           RTL8190_SUFFIX(read_nic_word)
...
#define write_nic_byte          RTL8190_SUFFIX(write_nic_byte)
#define write_nic_byte_E        RTL8190_SUFFIX(write_nic_byte_E)
#define write_nic_word          RTL8190_SUFFIX(write_nic_word)
#define write_nic_dword         RTL8190_SUFFIX(write_nic_dword)
#define force_pci_posting       RTL8190_SUFFIX(force_pci_posting)
...
#define setKey       RTL8190_SUFFIX(setKey)
