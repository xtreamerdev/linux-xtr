...
void ieee80211_wx_sync_scan_wq(struct ieee80211_device *ieee)
{
	...
	//2007-11-29, restore associating state for deassociate and deauth, added by thomas
	_BOOL Is_associating = _FALSE;
	if( ieee->state == IEEE80211_ASSOCIATING )
		Is_associating = _TRUE;
