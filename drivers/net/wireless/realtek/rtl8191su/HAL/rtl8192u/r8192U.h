...
#define COMP_MLME				BIT1		// Only for temporary debug message.
...
/**********************************************************/
	...
	u8 FwRsvdTxPageCfg;	// Firmware reserved Tx page number. Added by Roger, 2008.08.29.
...
#ifdef RTL8192SU
#if (LINUX_VERSION_CODE < KERNEL_VERSION(2,5,0))
	struct tq_struct	FwCmdIOWorkItem;
#else
	struct work_struct	FwCmdIOWorkItem;
#endif
#endif
...
//#endif
	...
	u8		RxDMACtrl; // For RxDMA control settings.
#endif
...
void SetHwReg8192SU(struct net_device *dev,u8 variable,u8* val);//added by amy 090330
#else
short rtl819xU_tx_cmd(struct net_device *dev, struct sk_buff *skb);
short rtl8192_tx(struct net_device *dev, struct sk_buff* skb);
bool init_firmware(struct net_device *dev);
void SetHwReg819xUsb(struct net_device *dev,u8 variable,u8* val);//added by thomas 090711
#endif
