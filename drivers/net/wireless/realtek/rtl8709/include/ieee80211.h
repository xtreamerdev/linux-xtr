...
struct ieee80211_qos_field
{
	u16	TID:4;
	u16	EOSP:1;
	u16	AckPolicy:2;
	u16	Reserved:1;		// Added by Annie, 2005-12-15.
	u16	TXOP:8;
...
extern u8 *get_ie(u8*pbuf, sint index, sint *len, sint limit);

extern void set_supported_rate(u8* SupportedRates, uint mode) ;

//extern unsigned int	get_rateset_len(unsigned char	*rateset);
struct registry_priv;
extern uint generate_ie(struct registry_priv *pregistrypriv);
